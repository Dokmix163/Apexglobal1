 ...
 *    - Для изменения кнопок "Что входит в комплекс" обновите includes[].icon/text
 *    - Для изменения фотографий в "Что входит в комплекс" измените includesDetailed[].image
 *    - Чтобы временно скрыть карточку или кнопку, установите includes[].enabled или includesDetailed[].enabled = false
 * 
...
export const bitumenTanks = [
  {
    ...
    includes: [
      { enabled: false , icon: '🛢️', text: 'Горизонтальная ёмкость 50 м³' },
